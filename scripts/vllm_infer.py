...
from forge.data import get_dataset, get_template_and_fix_tokenizer
from forge.extras.constants import IGNORE_INDEX
from forge.extras.misc import get_device_count
from forge.extras.packages import is_vllm_available
from forge.hparams import get_infer_args
from forge.model import load_tokenizer
...
def vllm_infer(
    ...
    # The result matrix is referencing src.forge.train.sft.workflow.run_sft # 127~132
