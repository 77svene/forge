...
register_model_group(
    models={
        ...
        "GLM-4-9B-Chat": {
            ...
            DownloadSource.OPENMIND: "forge/glm-4-9b-chat",
        },
        "GLM-4-9B-1M-Chat": {
...
register_model_group(
    models={
        ...
        "Llama-3-8B-Chinese-Chat": {
            ...
            DownloadSource.OPENMIND: "forge/Llama3-Chinese-8B-Instruct",
        },
...
register_model_group(
    models={
        ...
        "Yi-1.5-6B-Chat": {
            ...
            DownloadSource.OPENMIND: "forge/Yi-1.5-6B-Chat",
        },
        "Yi-1.5-9B-Chat": {
