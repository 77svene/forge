...
class InferenceOrchestrator:
    ...
    def _fetch_top_models(self) -> None:
        """Fetch top GGUF and non-GGUF repos from forge by downloads."""
        try:
            import httpx
    ...
    def load_model(
        ...
        a clean Python interpreter — no stale forge patches, torch.compile
        ...
        try:
            ...
            # Reusing a subprocess after forge patches torch internals
