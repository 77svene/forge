...
like forge, transformers, or torch before the version activation
...
def __getattr__(name):
    ...
    # Distributed Training Orchestration
    if name in ("DistributedTrainingOrchestrator", "get_distributed_training_orchestrator", "KubernetesOperator"):
        from .distributed import DistributedTrainingOrchestrator, get_distributed_training_orchestrator, KubernetesOperator
        ...
        globals()["KubernetesOperator"] = KubernetesOperator
        return globals()[name]
